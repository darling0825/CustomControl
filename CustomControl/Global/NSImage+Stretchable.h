...
- (NSImage *)stretchableImageWithSize:(NSSize)size
                           edgeInsets:(NSEdgeInsets)insets;

- (NSImage *)stretchableImageWithLeftCapWidth:(float)leftWidth
                                  middleWidth:(float)middleWidth
                                rightCapWidth:(float)rightWidth;
