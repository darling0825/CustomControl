...
- (void)mouseDown:(NSEvent *)theEvent
{
    ...
    if (index != NSNotFound &&
        [delegate respondsToSelector:@selector(collectionView:didClickItem:withViewController:)])
    {
        [delegate collectionView:self
                    didClickItem:[contentArray objectAtIndex:index]
              withViewController:[visibleViewControllers objectForKey:[NSNumber numberWithInt:index]]];
    }
  
    if (![self shiftOrCommandKeyPressed] &&
        ![selectionIndexes containsIndex:index])
    {
    ...
    if ([theEvent type] == NSLeftMouseDown &&
        ...
        [delegate respondsToSelector:@selector(collectionView:didDoubleClick:withViewController:)])
    {
        [delegate collectionView:self
                  didDoubleClick:[contentArray objectAtIndex:index]
              withViewController:[visibleViewControllers objectForKey:[NSNumber numberWithInt:index]]];
    }
