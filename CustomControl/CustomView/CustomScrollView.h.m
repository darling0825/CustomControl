...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    // Drawing code here.
    if (_stretchImage) {
        if (_drawType == BackgroundDrawType_Horizontal){
            [self drawHorizontalStretchImageV2];
        }
        else if (_drawType == BackgroundDrawType_Vertical){
            [self drawVerticalStretchImageV2];
        }
        else if (_drawType == BackgroundDrawType_NinePart){
...
- (void)drawImage
{
    ...
    if (!_stretchable) {
        //居中显示
        drawRect = NSMakeRect(fabsf((drawRect.size.width - imgSize.width)/2),
                              fabsf((drawRect.size.height - imgSize.height)/2),
                              imgSize.width,
                              imgSize.height);
    }
...
- (void)drawHorizontalStretchImage
{
    ...
    //从左往右
    NSDrawThreePartImage(drawRect, start, center, end, NO, NSCompositeSourceOver, 1, YES);
}
...
- (void)drawVerticalStretchImage
{
    ...
    //从上往下
    NSDrawThreePartImage(drawRect, start, center, end, YES, NSCompositeSourceOver, 1, YES);
}
...
- (void)drawVerticalStretchImageV2
{
    ...
    [_stretchImage drawInRect:NSMakeRect(0, 0, size.width, edgeInsets.top)
    ...
    [_stretchImage drawInRect:NSMakeRect(0, edgeInsets.top, size.width, size.height-edgeInsets.bottom-edgeInsets.top)
    ...
    [_stretchImage drawInRect:NSMakeRect(0, size.height-edgeInsets.bottom, size.width, edgeInsets.bottom)
...
- (void)drawNinePartStretchImageV2
{
    ...
    //11
    [_stretchImage drawInRect:NSMakeRect(0, 0, edgeInsets.left, edgeInsets.top)
               ...
               respectFlipped:YES
                        hints:nil];
    //12
    [_stretchImage drawInRect:NSMakeRect(edgeInsets.left-DistanceErrorEstimation, 0, size.width - edgeInsets.left - edgeInsets.right+2*DistanceErrorEstimation, edgeInsets.top)
               ...
               respectFlipped:YES
                        hints:nil];
    //13
    [_stretchImage drawInRect:NSMakeRect(size.width - edgeInsets.right, 0, edgeInsets.right, edgeInsets.top)
    ...
    //21
    [_stretchImage drawInRect:NSMakeRect(0, edgeInsets.top-DistanceErrorEstimation, edgeInsets.left, size.height-edgeInsets.bottom - edgeInsets.top+2*DistanceErrorEstimation)
               ...
               respectFlipped:YES
                        hints:nil];
    //22
    [_stretchImage drawInRect:NSMakeRect(edgeInsets.left-DistanceErrorEstimation, edgeInsets.top-DistanceErrorEstimation, size.width - edgeInsets.left - edgeInsets.right+2*DistanceErrorEstimation, size.height-edgeInsets.bottom - edgeInsets.top+2*DistanceErrorEstimation)
               ...
               respectFlipped:YES
                        hints:nil];
    //23
    [_stretchImage drawInRect:NSMakeRect(size.width - edgeInsets.right, edgeInsets.top-DistanceErrorEstimation, edgeInsets.right, size.height-edgeInsets.bottom - edgeInsets.top+2*DistanceErrorEstimation)
    ...
    //31
    [_stretchImage drawInRect:NSMakeRect(0, size.height-edgeInsets.bottom, edgeInsets.left, edgeInsets.bottom)
               ...
               respectFlipped:YES
                        hints:nil];
    //32
    [_stretchImage drawInRect:NSMakeRect(edgeInsets.left-DistanceErrorEstimation, size.height-edgeInsets.bottom, size.width - edgeInsets.left - edgeInsets.right+2*DistanceErrorEstimation, edgeInsets.bottom)
               ...
               respectFlipped:YES
                        hints:nil];
    //33
    [_stretchImage drawInRect:NSMakeRect(size.width - edgeInsets.right, size.height-edgeInsets.bottom, edgeInsets.right, edgeInsets.top)
